...
class TestAdapter(private val pContext: Context, val listaPreguntas: List<Pregunta>)
    : ArrayAdapter<Pregunta>(pContext,0, listaPreguntas){


    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {

        val layout = LayoutInflater.from(pContext).inflate(R.layout.test_item,parent, false)
        ...
        layout.findViewById<TextView>(R.id.btnR1).text = "A. $opt1"
        layout.findViewById<TextView>(R.id.btnR2).text = "B. $opt2"
        layout.findViewById<TextView>(R.id.btnR3).text = "C. $opt3"
        layout.findViewById<TextView>(R.id.btnR4).text = "D. $resp"
